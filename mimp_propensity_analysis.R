...
for (i in c(10, 20, 30, 40, 50, 60, 70, 80)) {
  ...
  ps.fit <- glm(enhanced_guidelines_yn ~ 
                  S_believe_climate_change_q +
                  S_believer_doubter +
                  S_burning_oil_co2 +
                  S_nuclear_power_co2 +
                  S_co2_methane +
                  S_global_co2_increase +
                  S_climate_change_human_activities +
                  S_last_century_global_increase +
                  S_today_concentration_already_occured +
                  S_scientists_expect_warming_increase_melting +
                  S_scientists_expect_increase_extreme_events +
                  S_scientists_expect_increase_water_evap +
                  S_scientists_expect_climate_change_evenly +
                  S_feelings_toward_fb +
                  S_gender +
                  S_age +
                  S_education +
                  S_politics +
