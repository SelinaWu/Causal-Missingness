...
for (percent in c("10", "20", "30", "40", "50", "60", "70", "80")) {
  data <- read.csv(paste0("data_clean_missing", percent,".csv"), stringsAsFactors = FALSE)
  ...
  write.csv(complete_df, paste0("data_clean_mimp", percent,".csv"), row.names=FALSE)
}
